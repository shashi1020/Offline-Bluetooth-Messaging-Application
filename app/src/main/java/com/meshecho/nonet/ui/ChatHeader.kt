...
import com.meshecho.nonet.core.ui.utils.singleOrTripleClickable
...
fun PeerCounter(
    ...
    Row(
        verticalAlignment = Alignment.CenterVertically,
        modifier = modifier.clickable { onClick() }.padding(end = 8.dp) // Added right margin to match "Echo" logo spacing
    ) {
